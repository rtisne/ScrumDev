...
class Example extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  {
    $this->open("/ScrumDev/src/web/sprintsProject.php?id_project=3");
    ...
    $this->assertTrue((bool)preg_match('/http:\/\/localhost\/ScrumDev\/src\/web\/kanban.php.*/',$this->getLocation()));
    $this->assertTrue($this->isElementPresent("xpath=(//button[@type='button'])[8]"));
  }
}
?>