...
class Example extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testMyTestCase()
  {
    ...
    $this->assertTrue((bool)preg_match('/http:\/\/localhost\/ScrumDev\/src\/web\/backlogProject.php\?id_project=.*[0-9]\&page=.*[0-9]/',$this->getLocation()));
  }
}
?>